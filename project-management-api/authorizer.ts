...
export function main(event, context, callback) {
    ...
    if (tokenBody['cognito:adminProjects']) adminProjectIds = tokenBody['cognito:adminProjects'].toString().split(',');
    if (tokenBody['cognito:managerProjects']) managerProjectIds = tokenBody['cognito:managerProjects'].toString().split(',');
    if (tokenBody['cognito:devProjects']) developerProjectIds = tokenBody['cognito:devProjects'].toString().split(',');
